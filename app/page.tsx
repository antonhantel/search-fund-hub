    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white">Our Offering</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-blue-500/50 transition-all duration-300 group">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">In-Person Events</h3>
            <p className="text-slate-400 leading-relaxed">
              We host a regular Stammtisch series across our four locations for operators, investors, M&A brokers, and active searchers. We also host flagship events designed as a beginner-friendly entry point into the ecosystem.
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-blue-500/50 transition-all duration-300 group">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">WhatsApp Community</h3>
            <p className="text-slate-400 leading-relaxed">
              Access our curated ETA ecosystem. Beyond our general group, we offer location-specific communities. Membership in local groups is exclusive to event attendees, ensuring a highly engaged, friendly, and relevant environment for those at every stage of their search journey.
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 hover:border-blue-500/50 transition-all duration-300 group">
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Intern & Working Student Job Board</h3>
            <p className="text-slate-400 leading-relaxed">
              The leading platform for ETA-focused student hiring. We leverage an exceptional proprietary network of university clubs to connect search funds with top talent from across Germany, Austria, and Switzerland (DACH).
            </p>
          </div>
        </div>
      </section>
